...
class DLTrainer:
    ...
    def __init__(self, rank, size, master='gpu10', dist=True, ngpus=1, batch_size=32, nsteps_update=1, 
    ...
    def cifar10_prepare(self):
        ...
        self.trainloader = torch.utils.data.DataLoader(trainset, batch_size=self.batch_size,
                                                  shuffle=shuffle, num_workers=0, sampler=train_sampler)
    ...
    def data_prepare(self):
        ...
        self.num_batches_per_epoch = self.get_num_of_training_samples() // (self.batch_size*self.nworkers*self.nsteps_update)
