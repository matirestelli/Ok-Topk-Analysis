...
#PBS -q backfill
#PBS -A UIC-HPC
#PBS -N lstm_gaussiank
#PBS -o logs/lstm_gaussiank_${PBS_JOBID}.out
#PBS -e logs/lstm_gaussiank_${PBS_JOBID}.err
...
echo "Running with $nworkers workers (gaussiank compression)"
nwpernode=1
sigmascale=2.5
PY=python
